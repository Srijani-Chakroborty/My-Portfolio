...
other digital product, I bring my commitment to build excellence and user-centered thinking to 
every project I work on. I look forward to the opportunity to bring my skills and passion to your next project.</p>
    ...
    <div className='col-span-3 relative h-max rounded-2xl border-2 border-solid border-dark bg-light p-8 dark:bg-dark dark:border-light'>
        ...
        <Image src={profilePic} als="srijani" className='w-full h-auto rounded-2xl'  priority
        ...
        <div className='col-span-2 flex flex-col items-end justify-center'>
            ...
            <div className='flex flex-col items-end py-8 justify-center'>
                <span className='inline-block text-7xl font-bold'>
