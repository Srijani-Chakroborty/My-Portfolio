...
const Skills = () => {
  return (
    ...
    <>
    <h2 className='font-bold text-8xl mt-36 w-full text-center md:text-6xl md:mt-36'>Skills</h2>
    ...
    sm:bg-circularLightSm sm:dark:bg-circularDarkSm'>
        <motion.div className='flex item-center justify-center rounded-full font-semibold bg-dark text-light p-8 shadow-dark cursor-pointer dark:text-dark dark:bg-light lg:p-6 md:p-4 xs:text-xs xs:p-2'
        whileHover={{scale:1.05}}>
            Dev
        </motion.div>
