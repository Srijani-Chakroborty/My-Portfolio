      ...
      <main className="flex w-full flex-col items-center justify-center dark:text-light">
        <Layout className="pt-16">
          ...
          <div className="grid w-full grid-cols-10 gap-16 sm:gap-8">
            <div className="col-span-3 flex flex-col items-start justify-start xl:col-span-3 md:order-2 md:col-span-8">
            ...
            <div className="col-span-3 gap-x-2 flex flex-col items-end justify-start xl:col-span-8 xl:flex-row xl:items-center xl:justify-center md:order-3">
              <div className="flex flex-col items-end py-8 justify-center xl:items-center">
                <span className="inline-block text-7xl font-bold md:text-6xl sm:text-5xl xs:text-4xl">
                  <AnimatedNumbers value={8} />+
                </span>
                <h2 className="text-xl mt-1 font-medium capitalize text-dark/75 dark:text-light/75 xl:text-center md:text-lg sm:text-base xs:text-sm">
                  Projects completed
                </h2>
              </div>
