...
const MovingImg=({title,img,link})=>{
    ...
    return(
        ...
        <FramerImage src={img} alt={title} className='z-10 w-96 h-auto absolute rounded-lg md:!hidden'
...
const Article=({img,title,date,link})=>{
    return(
        ...
        viewport={{once:true}} className='relative w-full p-4 py-6 my-4 rounded-xl flex items-center justify-between bg-light text-dark first:mt-0 border border-solid border-dark border-r-4 border-b-4 dark:border-light dark:bg-dark dark:text-light sm:flex-col'>
   ...
   <main className='w-full mb-16 flex flex-col items-center justify-center overflow-hidden dark:text-light'>
    <Layout className='pt-16'>
        ...
        <ul className='grid grid-cols-2 gap-16 lg:gap-8 md:gap-y-16 md:grid-cols-1'>
            ...
            time="5 min read" link="https://medium.com/@2022sp93013/blockchain-in-sustainable-development-a-paradigm-shift-towards-a-greener-future-9b94ed0e73ad" img={article1}
            />
            <FeaturedArticle
            ...
            time="5 min read" link="https://www.linkedin.com/posts/srijani-chakraborty-a0b42b1a0_genaideveloperdays-genai-aicommunity-activity-7147292924819517440-B58C?utm_source=share&utm_medium=member_desktop" img={article2}
            />
        </ul>
